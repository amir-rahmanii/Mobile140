                ...
                <div className='mt-8 flex justify-center'>
                    <form onSubmit={(e) => e.preventDefault()} className='flex flex-col gap-4'>
                        ...
                        <div className='bg-white flex items-center  h-[50px] rounded-[10px]'>
                            ...
                            <input {...register('email')} className='text-sm px-5 py-1 font-DanaMedium w-[269px] md:w-[368px] text-[#4D4D4D] text-left outline-none' type="text" placeholder="ایمیل خود را وارد کنید" />
                        </div>
